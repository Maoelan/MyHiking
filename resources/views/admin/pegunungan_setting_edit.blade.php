        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="nama_gunung" type="text" placeholder ="Nama Gunung" class="form-control @error('nama_gunung') is-invalid @enderror" name="nama_gunung" value="{{ $pegunungan -> nama_gunung }}" required autocomplete="nama_gunung" autofocus>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="letak_gunung" type="letak_gunung" placeholder ="Letak Gunung" class="form-control @error('letak_gunung') is-invalid @enderror" name="letak_gunung" value="{{ $pegunungan -> letak_gunung }}" required autocomplete="letak_gunung" autofocus>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="ketinggian_gunung" type="text" placeholder ="Ketinggian Gunung" class="form-control @error('ketinggian_gunung') is-invalid @enderror" name="ketinggian_gunung" value="{{ $pegunungan -> ketinggian_gunung }}" required autocomplete="ketinggian_gunung" autofocus>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="jenis_gunung" type="text" placeholder ="Jenis Gunung" class="form-control @error('jenis_gunung') is-invalid @enderror" name="jenis_gunung" value="{{ $pegunungan -> jenis_gunung }}" required autocomplete="jenis_gunung" autofocus>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <textarea id="deskripsi" type="text" placeholder ="Deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" value="" required autocomplete="deskripsi" autofocus>{{ $pegunungan -> deskripsi }}</textarea>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <textarea id="jalur_pendakian" type="text" placeholder ="Jalur Pendakian" class="form-control @error('jalur_pendakian') is-invalid @enderror" name="jalur_pendakian" value="" required autocomplete="jalur_pendakian" autofocus>{{ $pegunungan -> jalur_pendakian }}</textarea>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="level_pendakian" type="text" placeholder ="Level Pendakian" class="form-control @error('level_pendakian') is-invalid @enderror" name="level_pendakian" value="{{ $pegunungan -> level_pendakian }}" required autocomplete="level_pendakian" autofocus>
